...
export const personas: Persona[] = [
  {
    ...
    heroSub: 'Upload a clip, get personalized video feedback from a credential-checked coach in days. No travel, no scheduling.',
    primaryCta: 'download',
    why: [
      ...
      { heading: 'Credential-checked coaches, any sport', body: 'We review each coach\'s credentials, across 20+ sports — wherever you live.' },
    ],
    ...
    faqs: [
      { q: 'Is Ballmecca safe for minors?', a: 'Young athletes use parent-managed accounts, and we review every coach\'s credentials before they can coach.' },
